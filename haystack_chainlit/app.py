...
generative_pipeline.add_node(component=retriever,
                             name="retriever",
                             inputs=["Query"])
generative_pipeline.add_node(component=prompt_node,
                             name="prompt_node",
                             inputs=["retriever"])
...
async def main(message: str):
    ...
    response = await cl.make_async(generative_pipeline.run)(query)
